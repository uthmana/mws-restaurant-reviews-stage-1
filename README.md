...
- [x] Fully mobile-ready website using CSS grids, flexbox and media queries.

- [x] Improved accessibility of the website using [ARIA specifications](https://www.w3.org/TR/wai-aria/).
